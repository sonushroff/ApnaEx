...
# ------------------------------------------------
API_HASH = os.environ.get("API_HASH","7793761896:AAFPGWgzN06FppH66RtQCXSDtPkha7b45vI")
# ------------------------------------------------
BOT_TOKEN = os.environ.get("BOT_TOKEN", "")
# ------------------------------------------------
BOT_USERNAME = os.environ.get("BOT_USERNAME", "@TxtCoursewallah_bot")
BOT_TEXT = "COURSE WALLAH EXTRACTOR "
# ------------------------------------------------
...
# //FORCE_CHANNEL_ID
CHANNEL_ID2 = int(os.environ.get("CHANNEL_ID2", "-1003269980092")) 
# ------------------------------------------------
...
# -----------------------------------------------
PREMIUM_LOGS = int(os.environ.get("PREMIUM_LOGS", "-1003269980092"))
# -----------------------------------------------
